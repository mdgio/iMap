    ...
    function(declare, WidgetBase, TemplatedMixin, WidgetsInTemplateMixin, Toggler, Slider, dom, registry, query, domClass
        ...
        var _TOCNode = declare([WidgetBase, TemplatedMixin, WidgetsInTemplateMixin], {
        	templateString: '<div class="agsjsTOCNode">' + 
	            ...
	            /*<span style="float:right;font-weight:bold;"><a href="http://geodata.md.gov/imap/rest/services/"  target="_blank">Info</a></span> */ 
	            '</div></div>',
	        rootLayer: null,
	        layer: null,
	        legend: null,
	        ...
	        _createRootLayerNode: function(rootLayer) {
	           ...
	           // var parentTitle = this.layer.title;
	            //var lyr = this._parentLayerInfo.title;
                ...
                //ArcServer = 'geodata.md.gov/imap/rest/services/';
                // www.arcgis.com/sharing/rest/search/items/search?q=url:"http://geodata.md.gov/imap/rest/services/Environment/MD_ForestedBuffer/MapServer"&owner:mdimapdatacatalog&f=pjson
                preAGOLURL = "http://www.arcgis.com/sharing/rest/search/items/search?q=url:%22";
                postAGOLURL= "%22&owner:mdimapdatacatalog&f=pjson";
...
return objects;
 ...
 //var json = '<a href='+preAGOLURL + this.rootLayer.url.substring(0, this.rootLayer.url.length-1) + postAGOLURL ;   + '></a>'            
 //var js = JSON.parse(json);               
// AGOLid = console.log(getObjects(js,'id',''));             
                
 //               AGOLidURL ="https://www.arcgis.com/home/item.html?id=";
                
	            this.labelNode.innerHTML = title + '<span style="float:right;font-size:smaller;"><a href='+preAGOLURL + this.rootLayer.url.substring(0, this.rootLayer.url.length-1) + postAGOLURL + ' target=_blank>' + 'This' + '</a>';
