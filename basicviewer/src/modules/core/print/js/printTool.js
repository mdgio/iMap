...
//https://github.com/DavidSpriggs/print-widget-js
// it is awesome
define([
    'dojo/_base/declare',
    'dijit/_WidgetBase',
    ...
    var PrintDijit = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        pdfIcon: require.toUrl("./src/modules/core/print/images/pdf.png"),
        imageIcon: require.toUrl("./src/modules/core/print/images/image.png"),
        printTaskURL: null,
        printTask: null,
        postCreate: function () {
